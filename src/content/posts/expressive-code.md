...
description: 在 Markdown 中使用 Expressive Code 时代码块的样子。
tags: [Markdown, 博客, 演示]
category: 示例
draft: true
---

在这里，我们将探讨使用 [Expressive Code](https://expressive-code.com/) 时代码块的样子。提供的示例基于官方文档，您可以参考该文档获取更多详细信息。
